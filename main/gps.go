...
func initGPSSerial() bool {
	...
	if isSirfIV {
		...
		// RAM & BBR Layer configuration message
		// NMEA 4.0, NMEA extended svnumbering, dynamic model 7, AssistNow Autonomous, GPS+GAL+BDS+SBAS, 10Hz update rate, disable GLL
		payload := []byte{0xB5, 0x62, 0x06, 0x8A, 0x28, 0x00, 0x01, 0x02, 0x00, 0x00, 0x01, 0x00, 0x23, 0x10, 0x01, 0x21, 0x00, 0x11, 0x20, 0x07, 0x01, 0x00, 0x21, 0x30, 0x64, 0x00, 0x22, 0x00, 0x31, 0x10, 0x01, 0xCA, 0x00, 0x91, 0x20, 0x00, 0x01, 0x00, 0x93, 0x20, 0x28, 0x07, 0x00, 0x93, 0x20, 0x01, 0x74, 0xCE}
		p.Write(payload)
...
func writeUbloxGenericCommands(navrate uint16, p *serial.Port) {
	...
	// UBX-CFG-NAVX5 (enable AssistNow Autonomous)
	p.Write(makeUBXCFG(0x06, 0x23, 40, []byte{0x02, 0x00, 0x4C, 0x66, 0xC0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0x20, 0x06, 0x00, 0x00, 0x00, 0x00, 0x00, 0x4B, 0x07, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x64, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}))
